...
SQL_QUERY="${SQL_QUERY}
        ...
        CREATE USER '${MYSQL_USERNAME}'@'${MYSQL_BIND_ADDRESS}' IDENTIFIED BY '${MYSQL_USER_PASS}';
        GRANT ALL PRIVILEGES ON ${MYSQL_DATABASE_NAME}.* TO '${MYSQL_USERNAME}'@'${MYSQL_BIND_ADDRESS}';"
